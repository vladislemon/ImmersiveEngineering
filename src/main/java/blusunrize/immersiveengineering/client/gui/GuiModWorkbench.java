...
public class GuiModWorkbench extends GuiContainer {
                ...
                if (recipe != null && recipe.output != null)
                    if (func_146978_c(s.xDisplayPosition, s.yDisplayPosition, 16, 16, mx, my)) {
                        ...
                        for (Object o : recipe.inputs) {
                            ItemStack toAdd = (o instanceof ItemStack) ? (ItemStack) o
                                : (o instanceof ArrayList)
                                    ? ((ArrayList<ItemStack>) o)
                                        .get(ClientUtils.mc().thePlayer.ticksExisted / 10 % ((ArrayList) o).size())
                                    : null;
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int mx, int my) {
        ...
        for (int i = 0; i < ((ContainerModWorkbench) inventorySlots).slotCount; i++) {
            ...
            ClientUtils
                .drawColouredRect(guiLeft + s.xDisplayPosition - 1, guiTop + s.yDisplayPosition - 1, 17, 1, 0x77222222);
            ClientUtils
                .drawColouredRect(guiLeft + s.xDisplayPosition - 1, guiTop + s.yDisplayPosition + 0, 1, 16, 0x77222222);
            ClientUtils.drawColouredRect(
                guiLeft + s.xDisplayPosition + 16,
                guiTop + s.yDisplayPosition + 0,
                1,
                17,
                0x77999999);
            ClientUtils.drawColouredRect(
                guiLeft + s.xDisplayPosition + 0,
                guiTop + s.yDisplayPosition + 16,
                16,
                1,
                0x77999999);
            if (!(s instanceof IESlot.BlueprintOutput) || s.getHasStack()
        ...
        for (int i = 0; i < ((ContainerModWorkbench) inventorySlots).slotCount; i++) {
            ...
            if (s instanceof IESlot.BlueprintOutput && !s.getHasStack()) {
                ...
                if (ghostStack != null) {
                    ...
                    FontRenderer font = ghostStack.getItem()
                        .getFontRenderer(ghostStack);

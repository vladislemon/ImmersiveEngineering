...
public class BlockRenderMetalDecoration implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        if (meta == BlockMetalDecoration.META_fence || meta == BlockMetalDecoration.META_aluminiumFence) {
            ...
            return true;
        } else if (meta == BlockMetalDecoration.META_scaffolding || meta == BlockMetalDecoration.META_scaffolding2
            ...
            || meta == BlockMetalDecoration.META_aluminiumScaffolding2) {
                ...
                || meta == BlockMetalDecoration.META_aluminiumStructuralArm) {
                    ...
                    boolean inv = (te instanceof TileEntityStructuralArm) ? ((TileEntityStructuralArm) te).inverted
                        : false;
                    ForgeDirection fd = ForgeDirection.getOrientation(f);
                    int rowTop = 0;
                    while (rowTop < 8) {
                        TileEntity te2 = world
                            .getTileEntity(x - fd.offsetX * (rowTop + 1), y, z - fd.offsetZ * (rowTop + 1));
                        if (te2 instanceof TileEntityStructuralArm && ((TileEntityStructuralArm) te2).facing == f
                    ...
                    while (rowBot < 8) {
                        TileEntity te2 = world
                            .getTileEntity(x + fd.offsetX * (rowBot + 1), y, z + fd.offsetZ * (rowBot + 1));
                        if (te2 instanceof TileEntityStructuralArm && ((TileEntityStructuralArm) te2).facing == f
                    ...
                    tes.setColorOpaque_F(
                        info[0].colorRedBottomLeft,
                        info[0].colorGreenBottomLeft,
                        info[0].colorBlueBottomLeft);
                    tes.setBrightness(info[0].brightnessBottomLeft);
                    tes.addVertexWithUV(x + 0, y + (inv ? 1 - y00 : 0), z + 0, d3, d5);
                    tes.setColorOpaque_F(
                        info[0].colorRedBottomRight,
                        info[0].colorGreenBottomRight,
                        info[0].colorBlueBottomRight);
                    tes.setBrightness(info[0].brightnessBottomRight);
                    tes.addVertexWithUV(x + 1, y + (inv ? 1 - y10 : 0), z + 0, d7, d9);
                    tes.setColorOpaque_F(
                        info[0].colorRedTopRight,
                        info[0].colorGreenTopRight,
                        info[0].colorBlueTopRight);
                    tes.setBrightness(info[0].brightnessTopRight);
                    tes.addVertexWithUV(x + 1, y + (inv ? 1 - y11 : 0), z + 1, d4, d6);

                    tes.setColorOpaque_F(
                        info[1].colorRedBottomLeft,
                        info[1].colorGreenBottomLeft,
                        info[1].colorBlueBottomLeft);
                    ...
                    tes.setColorOpaque_F(
                        info[1].colorRedTopRight,
                        info[1].colorGreenTopRight,
                        info[1].colorBlueTopRight);
                    tes.setBrightness(info[1].brightnessTopRight);
                    tes.addVertexWithUV(x + 1, y + (inv ? 1 - y11 : 0) + .0001, z + 1, d8, d6);
                    tes.setColorOpaque_F(
                        info[1].colorRedBottomRight,
                        info[1].colorGreenBottomRight,
                        info[1].colorBlueBottomRight);
                    ...
                    tes.addVertexWithUV(
                        ...
                        z + 0,
                        iSide.getMaxU(),
                        iSide.getInterpolatedV((1 - y00) * 16));
                    tes.setColorOpaque_F(
                        info[2].colorRedBottomLeft,
                        info[2].colorGreenBottomLeft,
                        info[2].colorBlueBottomLeft);
                    ...
                    tes.addVertexWithUV(
                        ...
                        z + 0,
                        iSide.getMinU(),
                        iSide.getInterpolatedV((1 - y10) * 16));
                    tes.setColorOpaque_F(
                        info[2].colorRedBottomRight,
                        info[2].colorGreenBottomRight,
                        info[2].colorBlueBottomRight);
                    tes.setBrightness(info[2].brightnessBottomRight);
                    tes.addVertexWithUV(x + 1, y + (inv ? 1 : 0), z + 0, iSide.getMinU(), iSide.getMaxV());
                    tes.setColorOpaque_F(
                        info[2].colorRedTopRight,
                        info[2].colorGreenTopRight,
                        info[2].colorBlueTopRight);
                    tes.setBrightness(info[2].brightnessTopRight);
                    tes.addVertexWithUV(x + 0, y + (inv ? 1 : 0), z + 0, iSide.getMaxU(), iSide.getMaxV());

                    tes.setColorOpaque_F(
                        info[3].colorRedBottomLeft,
                        info[3].colorGreenBottomLeft,
                        info[3].colorBlueBottomLeft);
                    ...
                    tes.setColorOpaque_F(
                        info[3].colorRedTopRight,
                        info[3].colorGreenTopRight,
                        info[3].colorBlueTopRight);
                    tes.setBrightness(info[3].brightnessTopRight);
                    tes.addVertexWithUV(x + 0, y + (inv ? 1 : 0), z + 0 + .0001, iSide.getMaxU(), iSide.getMinV());
                    tes.setColorOpaque_F(
                        info[3].colorRedBottomRight,
                        info[3].colorGreenBottomRight,
                        info[3].colorBlueBottomRight);
                    ...
                    tes.addVertexWithUV(
                        ...
                        z + 1,
                        iSide.getMinU(),
                        iSide.getInterpolatedV((1 - y01) * 16));
                    tes.setColorOpaque_F(
                        info[3].colorRedBottomLeft,
                        info[3].colorGreenBottomLeft,
                        info[3].colorBlueBottomLeft);
                    ...
                    tes.addVertexWithUV(
                        ...
                        z + 1,
                        iSide.getMaxU(),
                        iSide.getInterpolatedV((1 - y11) * 16));
                    ...
                    tes.addVertexWithUV(
                        ...
                        iSide.getInterpolatedV((1 - y01) * 16));
                    tes.setColorOpaque_F(
                        info[4].colorRedBottomLeft,
                        info[4].colorGreenBottomLeft,
                        info[4].colorBlueBottomLeft);
                    ...
                    tes.addVertexWithUV(
                        ...
                        iSide.getInterpolatedV((1 - y00) * 16));
                    tes.setColorOpaque_F(
                        info[4].colorRedBottomRight,
                        info[4].colorGreenBottomRight,
                        info[4].colorBlueBottomRight);
                    tes.setBrightness(info[4].brightnessBottomRight);
                    tes.addVertexWithUV(x + 0, y + (inv ? 1 : 0), z + 0, iSide.getMinU(), iSide.getMaxV());
                    tes.setColorOpaque_F(
                        info[4].colorRedTopRight,
                        info[4].colorGreenTopRight,
                        info[4].colorBlueTopRight);
                    tes.setBrightness(info[4].brightnessTopRight);
                    tes.addVertexWithUV(x + 0, y + (inv ? 1 : 0), z + 1, iSide.getMaxU(), iSide.getMaxV());

                    tes.setColorOpaque_F(
                        info[5].colorRedBottomLeft,
                        info[5].colorGreenBottomLeft,
                        info[5].colorBlueBottomLeft);
                    ...
                    tes.addVertexWithUV(
                        ...
                        iSide.getInterpolatedV(y01 * 16));
                    tes.setColorOpaque_F(
                        info[5].colorRedTopRight,
                        info[5].colorGreenTopRight,
                        info[5].colorBlueTopRight);
                    tes.setBrightness(info[5].brightnessTopRight);
                    tes.addVertexWithUV(x + 0 + .0001, y + (inv ? 1 : 0), z + 1, iSide.getMaxU(), iSide.getMinV());
                    tes.setColorOpaque_F(
                        info[5].colorRedBottomRight,
                        info[5].colorGreenBottomRight,
                        info[5].colorBlueBottomRight);

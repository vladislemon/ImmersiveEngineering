            ...
            if (sCase instanceof ShaderCaseBalloon) {
                ...
                if (balloon.style == 0) {
                    ...
                    ClientUtils.renderStaticWavefrontModelWithIcon(
                        ...
                        "balloon1_0",
                        "balloon1_1");
                    // ClientUtils.renderStaticWavefrontModel(tile, model.model, tes, translationMatrix, rotationMatrix,
                    // -1,false, col0[0],col0[1],col0[2], "balloon0_0","balloon0_1");
                    // ClientUtils.renderStaticWavefrontModel(tile, model.model, tes, translationMatrix, rotationMatrix,
                    // -1,false, col1[0],col1[1],col1[2], "balloon1_0","balloon1_1");
                } else {
                    ClientUtils.renderStaticWavefrontModelWithIcon(
                        balloon,
                        model,
                    ...
                    ClientUtils.renderStaticWavefrontModelWithIcon(
                        ...
                        "balloon1_1");
                    // ClientUtils.renderStaticWavefrontModel(tile, model.model, tes, translationMatrix, rotationMatrix,
                    // -1,false, col0[0],col0[1],col0[2], "balloon0_0","balloon1_0");
                    // ClientUtils.renderStaticWavefrontModel(tile, model.model, tes, translationMatrix, rotationMatrix,
                    // -1,false, col1[0],col1[1],col1[2], "balloon0_1","balloon1_1");
                }
            }
        }
    }

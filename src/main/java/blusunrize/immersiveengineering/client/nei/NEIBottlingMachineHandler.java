...
public class NEIBottlingMachineHandler extends TemplateRecipeHandler {
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId == getOverlayIdentifier()) for (BottlingMachineRecipe r : BottlingMachineRecipe.recipeList)
    ...
    public void loadUsageRecipes(String inputId, Object... ingredients) {
        ...
        if (fs != null) for (BottlingMachineRecipe r : BottlingMachineRecipe.recipeList)
    ...
    public void loadCraftingRecipes(ItemStack result) {
        if (result != null) for (BottlingMachineRecipe r : BottlingMachineRecipe.recipeList)
    ...
    public boolean mouseClicked(GuiRecipe gui, int button, int recipe) {
        ...
        CachedBottlingMachineRecipe r = (CachedBottlingMachineRecipe) this.arecipes.get(recipe % arecipes.size());
        if (r != null) {
            if (new Rectangle(15, 5, 18, 50).contains(relMouse)) if (button == 0) {
                if (GuiCraftingRecipe.openRecipeGui("liquid", new Object[] { r.fluid })) return true;
            } else if (button == 1) {
                if (GuiUsageRecipe.openRecipeGui("liquid", new Object[] { r.fluid })) return true;
            }

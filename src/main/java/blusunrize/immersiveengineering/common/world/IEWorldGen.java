...
public class IEWorldGen implements IWorldGenerator {
    ...
    public static class OreGen {
        ...
        public OreGen(Block block, int meta, int maxVeinSize, Block replaceTarget, int minY, int maxY,
            int chunkOccurence, int weight) {
        ...
        public void generate(World world, Random rand, int x, int z) {
            for (int i = 0; i < chunkOccurence; i++) if (rand.nextInt(100) < weight) {
    ...
    public static OreGen addOreGen(Block block, int meta, int maxVeinSize, int minY, int maxY, int chunkOccurence,
        int weight) {

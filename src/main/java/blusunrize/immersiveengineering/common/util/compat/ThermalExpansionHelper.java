...
public class ThermalExpansionHelper extends IECompatModule {
    ...
    public void postInit() {
        ...
        if (blockFrame != null) {
            ...
            if (fluidEnder != null) BottlingMachineRecipe.addRecipe(
            ...
            if (fluidGlowstone != null && blockIlluminator != null) BottlingMachineRecipe.addRecipe(
    ...
    public static void addSmelterRecipe(ItemStack output, ItemStack input0, ItemStack input1, int energy,
        ItemStack secondaryOuput, int secondaryChance) {

...
public class AvaritiaHelper extends IECompatModule {
    ...
    public void init() {
        ...
        ShaderRegistry.shaderRegistry.put(
            ...
            new ShaderRegistry.ShaderRegistryEntry(
                ...
                new CosmicShaderCaseMinecart(overlayType, colourBackground, colourPrimary, colourSecondary, null))
                    .setBagLoot(true)
        ...
        if (Loader.isModLoaded("TConstruct")) {
            ...
            if (itemToolrod != null) {
                ...
                RailgunHandler.registerProjectileProperties(new ItemStack(itemToolrod, 1, 501), 800, 2)
                    .setColourMap(
                        new int[][] { { 0xe64452, 0xe64452, 0xe64452, 0xff425f, 0xff425f },
    ...
    static class CosmicShaderCaseChemthrower extends ShaderCaseChemthrower {
        ...
        public CosmicShaderCaseChemthrower(String overlayType, int[] colourGrip, int[] colourPrimary,
            int[] colourSecondary, boolean cageOnBase, boolean tanksUncoloured, String additionalTexture) {
            super(
                overlayType,
                colourGrip,
                colourPrimary,
    ...
    static class CosmicShaderCaseDrill extends ShaderCaseDrill {
        ...
        public CosmicShaderCaseDrill(String overlayType, int[] colourGrip, int[] colourPrimary, int[] colourSecondary,
    ...
    static class CosmicShaderCaseRailgun extends ShaderCaseRailgun {
        ...
        public CosmicShaderCaseRailgun(String overlayType, int[] colourGrip, int[] colourPrimary, int[] colourSecondary,
            String additionalTexture) {
            super(overlayType, colourGrip, colourPrimary, colourSecondary, additionalTexture);
        }
    ...
    static class CosmicShaderCaseMinecart extends ShaderCaseMinecart {
        ...
        public CosmicShaderCaseMinecart(String overlayType, int[] colourUnderlying, int[] colourPrimary,
            int[] colourSecondary, String additionalTexture) {
    ...
    static class CosmicShaderCaseRevolver extends ShaderCaseRevolver {
        ...
        public CosmicShaderCaseRevolver(String overlayType, int[] colourGrip, int[] colourPrimary,
            int[] colourSecondary, int[] colourBlade, String additionalTexture) {
        ...
        public IIcon getReplacementIcon(ItemStack shader, ItemStack item, String modelPart, int pass) {
            ...
            if (modelPart.equals("player_bayonet") || modelPart.equals("dev_bayonet")

    ...
    public List<String> getWailaBody(ItemStack itemStack, List<String> currenttip, IWailaDataAccessor accessor,
        ...
        if (b instanceof BlockIECrop) {
            ...
            if (min == max) currenttip.add(
                ...
                if (growth < 100.0) currenttip
                    .add(String.format("%s : %.0f %%", StatCollector.translateToLocal("hud.msg.growth"), growth));
                else currenttip.add(
                    String.format(
                        "%s : %s",
                        StatCollector.translateToLocal("hud.msg.growth"),
        ...
        if (tile instanceof TileEntityWoodenBarrel) {
            NBTTagCompound tank = accessor.getNBTData()
                .getCompoundTag("tank");

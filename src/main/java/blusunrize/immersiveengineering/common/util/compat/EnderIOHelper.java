...
public class EnderIOHelper extends IECompatModule {
    ...
    public void init() {
        ...
        Object dustEnderPearl = ApiUtils.isExistingOreName("dustEnderPearl") ? "dustEnderPearl"
            : new ItemStack(itemPowder, 1, 5);
        ...
        ChemthrowerHandler
            .registerEffect("nutrient_distillation", new ChemthrowerEffect_Potion(null, 0, Potion.confusion, 80, 1));
    }

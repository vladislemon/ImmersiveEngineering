...
public class HydCraftHelper extends IECompatModule {
    ...
    public void init() {
        HCApi.getInstance()
            .getTrolleyRegistrar()
            .registerTrolley(new IETrolley());

        ItemStack ieTrolly = HCApi.getInstance()
            .getTrolleyRegistrar()
            .getTrolleyItem("ieCrop");
        ...
        if (pressureCore != null && pressureWall != null && hydraulicPiston != null && fLube != null)
            HCApi.getInstance()
                .getRecipeHandler()
                .addAssemblerRecipe(
                    new FluidShapedOreRecipe(
                        ieTrolly,
                        new Object[] { true,
                            new Object[] { " P ", "WCW", "SIS", 'C', new ItemStack(pressureCore, 1, 1), 'W',
                                pressureWall, 'S', "treatedStick", 'I', "ingotIron", 'P', hydraulicPiston } })

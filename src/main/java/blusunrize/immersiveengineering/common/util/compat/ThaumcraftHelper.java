...
public class ThaumcraftHelper extends IECompatModule {
    ...
    public void init() {
        ChemthrowerHandler
            .registerEffect("fluiddeath", new ChemthrowerEffect_Damage(DamageSourceThaumcraft.dissolve, 4));
        for (Potion potion : Potion.potionTypes) if (potion != null && potion.getName()
            .equals("potion.warpward"))
            ChemthrowerHandler.registerEffect("fluidpure", new ChemthrowerEffect_Potion(null, 0, potion, 100, 0));
        else if (potion != null && potion.getName()
            .equals("potion.visexhaust"))
                ...
                if (canSmelt) {
                    ...
                    if (time < 200) {
                        ...
                        if (heat > 0) {
                            ...
                            if (!burning) tileEntity.getWorldObj()

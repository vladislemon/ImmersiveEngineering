...
public class GregTechHelper extends IECompatModule {
    ...
    public void init() {
        ...
        IERecipes
            .addOreDictAlloyingRecipe("ingotMagnalium", 3, "Magnesium", 200, 512, "dustAluminium", "dustAluminium");
        IERecipes.addOreDictAlloyingRecipe(
            "ingotBatteryAlloy",
            5,
            "Antimony",
        ...
        for (MineralMix min : ExcavatorHandler.mineralList.keySet()) if (min.name.equalsIgnoreCase("Magnetite")) {
        ...
        ExcavatorHandler.addMineral(
            ...
            15,
            .2f,
            new String[] { "oreTungsten", "oreIron", "oreManganese" },
            new float[] { .55f, .3f, .15f });

        for (GregsTerribleFluidPotions fluidPotion : GregsTerribleFluidPotions.values()) {
            String potionName = "potion." + fluidPotion.toString()
                .toLowerCase();
            ChemthrowerHandler.registerEffect(
                ...
                new ChemthrowerEffect_Potion(
                    ...
                    0,
                    fluidPotion.potion,
                    fluidPotion.baseDuration,
                    fluidPotion.baseAmplifier));
            if (fluidPotion.strong) ChemthrowerHandler.registerEffect(
                potionName + ".strong",
                new ChemthrowerEffect_Potion(
                    null,
                    0,
            ...
            if (fluidPotion.extended) ChemthrowerHandler.registerEffect(
                potionName + ".long",
                new ChemthrowerEffect_Potion(
                    null,
                    0,
                    fluidPotion.potion,
                    fluidPotion.baseDuration * 2,
                    fluidPotion.baseAmplifier));

            if (fluidPotion.splash) ChemthrowerHandler.registerEffect(
                potionName + ".splash",
                new ChemthrowerEffect_Potion(
                    null,
                    0,
                    ...
                    fluidPotion.baseAmplifier));
            if (fluidPotion.strong && fluidPotion.splash) ChemthrowerHandler.registerEffect(
                ...
                new ChemthrowerEffect_Potion(
                    ...
                    fluidPotion.baseAmplifier + 1));
            if (fluidPotion.extended && fluidPotion.splash) ChemthrowerHandler.registerEffect(
        ...
        ChemthrowerHandler.registerEffect(
            "lubricant",
            new ChemthrowerEffect_Potion(null, 0, new PotionEffect(IEPotions.slippery.id, 80, 0)));
        ChemthrowerHandler
            .registerEffect("sulfuricacid", new ChemthrowerEffect_Damage(IEDamageSources.causeAcidDamage(), 2));
    ...
    public static long gregtech_outputGTPower(Object energyContainer, byte side, long volt, long amp,
        boolean simulate) {
    ...
    public static enum GregsTerribleFluidPotions {
        ...
        private GregsTerribleFluidPotions(Potion pot, int baseDur, int baseAmp, boolean strong, boolean extended,
            boolean splash) {
            this.potion = pot;

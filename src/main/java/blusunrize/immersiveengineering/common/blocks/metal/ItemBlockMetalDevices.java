...
public class ItemBlockMetalDevices extends ItemBlockIEBase {
        ...
        if (((BlockIEBase) field_150939_a).subNames[stack.getItemDamage()].startsWith("capacitor")) {
            list.add(
                StatCollector.translateToLocalFormatted(
                    "desc.ImmersiveEngineering.info.energyStored",
            ...
            if (ItemNBTHelper.hasKey(stack, "sideConfig") && GuiScreen.isShiftKeyDown()) {
                ...
                String sq = "\u25FC";
                String top = (s[1] == 0 ? EnumChatFormatting.BLUE
                    : s[1] == 1 ? EnumChatFormatting.GOLD : EnumChatFormatting.DARK_GRAY) + sq;
                String bot = (s[0] == 0 ? EnumChatFormatting.BLUE
                    : s[0] == 1 ? EnumChatFormatting.GOLD : EnumChatFormatting.DARK_GRAY) + sq;
                String front = (s[3] == 0 ? EnumChatFormatting.BLUE
                    : s[3] == 1 ? EnumChatFormatting.GOLD : EnumChatFormatting.DARK_GRAY) + sq;
                String back = (s[2] == 0 ? EnumChatFormatting.BLUE
                    : s[2] == 1 ? EnumChatFormatting.GOLD : EnumChatFormatting.DARK_GRAY) + sq;
                String left = (s[4] == 0 ? EnumChatFormatting.BLUE
                    : s[4] == 1 ? EnumChatFormatting.GOLD : EnumChatFormatting.DARK_GRAY) + sq;
                String right = (s[5] == 0 ? EnumChatFormatting.BLUE
                    : s[5] == 1 ? EnumChatFormatting.GOLD : EnumChatFormatting.DARK_GRAY) + sq;
    ...
    public boolean placeBlockAt(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        if (meta == BlockMetalDevices.META_transformer || meta == BlockMetalDevices.META_transformerHV) {
            ...
            if ((meta != BlockMetalDevices.META_transformer || !(blockPost instanceof IPostBlock
        ...
        if (meta == BlockMetalDevices.META_connectorLV || meta == BlockMetalDevices.META_connectorMV
        ...
        if ((meta == BlockMetalDevices.META_conveyorBelt || meta == BlockMetalDevices.META_conveyorDropper) && side != 0
            && side != 1) {
            ...
            if (tileEntity instanceof TileEntityConveyorBelt) {
                ...
                if (con.transportUp && con.facing == ForgeDirection.OPPOSITES[side]
                    && hitY > .75
                    && world.isAirBlock(x, y + 1, z)) y++;
                else if (((con.transportUp && con.facing == side)
                    || (con.transportDown && con.facing == ForgeDirection.OPPOSITES[side])) && hitY <= .125
        ...
        if (tileEntity instanceof TileEntityRelayHV) {
            ...
            if (ItemNBTHelper.hasKey(stack, "energyStorage")) ((TileEntityCapacitorLV) tileEntity).energyStorage
                .setEnergyStored(ItemNBTHelper.getInt(stack, "energyStorage"));
            ...
            ((TileEntityConnectorLV) tileEntity).facing = ForgeDirection.getOrientation(side)
                .getOpposite()
                .ordinal();
            ...
            int postZ = z + (side == 2 ? 1 : side == 3 ? -1 : 0);
            Block blockPost = world.getBlock(postX, y, postZ);
            if (meta == 4 && blockPost instanceof IPostBlock
                && ((IPostBlock) blockPost).canConnectTransformer(world, postX, y, postZ)) {
            ...
            if (conveyorFacingPre != -1 || conveyorModePre != -1) {
                ...
                TileEntityConveyorBelt con = (TileEntityConveyorBelt) world
                    .getTileEntity(x + fd.offsetX, y + 1, z + fd.offsetZ);
                if (ForgeDirection.getOrientation(con.facing)
                    .equals(fd)) {
                ...
                if (ForgeDirection.getOrientation(con.facing)
                    .getOpposite()
                    .equals(fd)) con.transportDown = true;
            } else if (world.getTileEntity(x - fd.offsetX, y - 1, z - fd.offsetZ) instanceof TileEntityConveyorBelt) {
                TileEntityConveyorBelt con = (TileEntityConveyorBelt) world
                    .getTileEntity(x - fd.offsetX, y - 1, z - fd.offsetZ);
            ...
            if (world.getTileEntity(x - fd.offsetX, y, z - fd.offsetZ) instanceof TileEntityConveyorBelt) {
                TileEntityConveyorBelt con = (TileEntityConveyorBelt) world
                    .getTileEntity(x - fd.offsetX, y, z - fd.offsetZ);

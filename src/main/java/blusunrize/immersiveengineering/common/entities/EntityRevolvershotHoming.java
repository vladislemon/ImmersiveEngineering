...
public class EntityRevolvershotHoming extends EntityRevolvershot {
    ...
    public EntityRevolvershotHoming(World world, double x, double y, double z, double ax, double ay, double az,
        int type) {
        super(world, x, y, z, ax, ay, az, type);
    }

    public EntityRevolvershotHoming(World world, EntityLivingBase living, double ax, double ay, double az, int type,
        ItemStack stack) {
    ...
    public EntityLivingBase getTarget() {
        ...
        for (Object o : worldObj.getEntitiesWithinAABB(EntityLivingBase.class, aabb))
            if (o instanceof EntityLivingBase && !o.equals(this.shootingEntity)) if (target == null

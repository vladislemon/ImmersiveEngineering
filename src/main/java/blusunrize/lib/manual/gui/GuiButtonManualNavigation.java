...
public class GuiButtonManualNavigation extends GuiButton {
    ...
    public void drawButton(Minecraft mc, int mx, int my) {
        if (this.visible) {
            ...
            this.field_146123_n = mx >= this.xPosition && mx < (this.xPosition + this.width)
                && my >= this.yPosition
            ...
            int u = type == 5 ? 46
                : type == 4 || type == 6 ? 36
                    : (type < 2 ? 0 : type < 3 ? 16 : 26) + (type > 1 ? (10 - width) : type == 1 ? (16 - width) : 0);
            int v = 216 + (type == 0 ? 0
                : type == 1 ? 10 : type == 2 ? (16 - height) : type == 3 ? 0 : type == 4 || type == 5 ? 10 : 0);
